...
export default function AppCrm({ onNavigate }: { onNavigate?: (p: Page, anchor?: string, action?: QAction) => void }) {
  return (
    <ToastProvider>
...
function Shell({ onNavigate }: { onNavigate?: (p: Page, anchor?: string, action?: QAction) => void }) {
