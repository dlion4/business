...
/* ============ Toast host ============ */
export function ToastHost({ toasts, dismissToast }: { toasts: Array<{ id: number; msg: string; type: "success" | "info" | "warning" | "danger"; title?: string }>; dismissToast: (id: number) => void }) {
  return (
