...
type NavPage = "getpaid" | "paysuppliers" | "cash" | "books" | "crm";

export default function App({ onNavigate, pendingAction }: { onNavigate?: (p: NavPage, anchor?: string, action?: QAction) => void; pendingAction?: QAction }) {
  return (
    <ToastProvider>
...
function Shell({ onNavigate, pendingAction }: { onNavigate?: (p: NavPage, anchor?: string, action?: QAction) => void; pendingAction?: QAction }) {
